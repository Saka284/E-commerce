...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li><a href="shopping-cart.php"><i class="fa fa-shoping-bag"></i> <span>3</span></a></li>
            </ul>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Ayam</a></li>
                            <li><a href="#">Ikan</a></li>
                            <li><a href="#">Butter & Telur</a></li>
                            <li><a href="#">Fastfood</a></li>
                            <li><a href="#">Bawang</a></li>
                            <li><a href="#">Berries Segar</a></li>
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                <input type="text" placeholder="Cari Buah dan Sayuran disini...">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/banner.jpg">
                        <div class="hero__text">
                            ...
                            <a href="shop-grid.php" class="primary-btn">Beli Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
